...
#testovaci verze s XMLRPC
from SimpleXMLRPCServer import SimpleXMLRPCServer
server = SimpleXMLRPCServer(('172.16.34.157', 1776), logRequests=True, allow_none=True)
...
server.register_function(set_panel_memory_from_matrix)
server.register_function(set_pixel_color)
server.register_function(panel_clear)
server.register_function(rainbow)
server.register_function(matrix)
