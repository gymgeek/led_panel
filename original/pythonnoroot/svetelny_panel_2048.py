...
class Game2048(object):
    ...
    COLORS = ["000000", "ff0000", "ff6500", "ffff00", "65ff00", "00ff00", "00ff65", "00ffff", "0065ff", \
    "0000ff", "6500ff", "ff00ff", "0000ff" ]
    ...
    def init(self, wi):
        global board
        self.board = [[0 for _ in range(self.BOARDX)] for _ in range(self.BOARDY)]
        self.addtile()
        self.draw()
        self.playing=True
        
	rectangle(0, 0, self.BOARDX+1, self.BOARDY+1, "101010")
	self.play(wi)
    ...
    #Draw board to pl)anel/print to console
    def draw(self):
        board = self.board
        for line in board:
            print line
        ...
        for x in range(len(board)):
            for y in range(len(board[0])):
                set_pixel_color(matrix(x+1,y+1), colors[board[x][y]])
    ...
    def addtile(self):
        ...
        while True:
                tryed += 1
                x = randint(0,self.BOARDX-1)
                y = randint(0,self.BOARDY-1)
                if(board[x][y] == 0):
                        board[x][y] = 1
                        return True
                if(tryed > 100):
    ...
    # -------------------DOWN---------------------
    def shiftdown(self):        
        for colum in range(self.BOARDY):
            if(self.checkvertical(colum)):
               for line in range(self.BOARDX):                   
                   for _ in range(self.BOARDY):
                       for tile in range(self.BOARDY-1):
    ...
    def downcount(self):
        for line in range(self.BOARDX-1):
            for colum in range(self.BOARDY):
        ...
        for colum in range(self.BOARDY):
            if(self.checkvertical(colum)):
               for line in range(self.BOARDX):                   
                   for _ in range(self.BOARDY):
                       for tile in range(self.BOARDY-1):
                           if self.board[(self.BOARDY-1)-tile][colum] == 0:
                               self.board[(self.BOARDY-1)-tile][colum] = self.board[(self.BOARDY-1)-(tile+1)][colum]
                               self.board[(self.BOARDY-1)-(tile+1)][colum] = 0
    ...
    def upcount(self):
        for line in range(self.BOARDX-1):
            for colum in range(self.BOARDY):
                if self.board[(self.BOARDY-1)-line][colum] == self.board[(self.BOARDY-1)-(line+1)][colum] \
		and self.board[(self.BOARDY-1)-line][colum] != 0:
                    self.board[(self.BOARDY-1)-line][colum] += 1
                    self.board[(self.BOARDY-1)-(line+1)][colum] = 0
    ...
    def shiftleft(self):
        for line in range(self.BOARDX):
            if(self.checkhorizontal(line)):
               for colum in range(self.BOARDX):                   
                   for _ in range(self.BOARDY):
                       for tile in range(self.BOARDX-1):
    ...
    def leftcount(self):
        for line in range(self.BOARDX):
            for colum in range(self.BOARDY-1):
        ...
        for line in range(self.BOARDX):
            if(self.checkhorizontal(line)):
               for colum in range(self.BOARDX):                   
                   for _ in range(self.BOARDY):
                       for tile in range(self.BOARDX-1):
                           if self.board[line][(self.BOARDX-1)-tile] == 0:
                               self.board[line][(self.BOARDX-1)-tile] = self.board[line][(self.BOARDX-1)-(tile+1)]
                               self.board[line][(self.BOARDX-1)-(tile+1)] = 0
    ...
    def rightcount(self):
         for line in range(self.BOARDX):
            for colum in range(self.BOARDY-1):
                if self.board[line][(self.BOARDX-1)-colum] == self.board[line][(self.BOARDX-1)-(colum+1)] \
		and self.board[line][(self.BOARDX-1)-colum] != 0:
                    self.board[line][(self.BOARDX-1)-colum] += 1
                    self.board[line][(self.BOARDX-1)-(colum+1)] =0
